...
-- -----------------------------------------------------
-- Table `DB_COMERCIO`.`TIPO_PESSOA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`TIPO_PESSOA` (
  `COD_TIPO_PESSOA` INT NOT NULL,
  `DSC_TIPO_PESSOA` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`PESSOA` (
  ...
  `COD_TIPO_PESSOA` INT NULL,
  `NUM_TELEFONE` VARCHAR(45) NULL,
  `DSC_EMAIL` VARCHAR(100) NULL,
  PRIMARY KEY (`COD_PESSOA`),
  INDEX `FK_TIPO_PESSOA_idx` (`COD_TIPO_PESSOA` ASC) ,
  CONSTRAINT `FK_TIPO_PESSOA`
    FOREIGN KEY (`COD_TIPO_PESSOA`)
    REFERENCES `DB_COMERCIO`.`TIPO_PESSOA` (`COD_TIPO_PESSOA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`OPERACAO` (
  ...
  `TPO_STATUS` ENUM('P', 'O') NULL DEFAULT NULL COMMENT 'P - pedido (compra ou venda)\no - orçamento\n',
  `COD_PESSOA` INT(11) NULL DEFAULT NULL,
  `FLG_PAGO` TINYINT(4) NULL DEFAULT NULL,
  `FLG_TIPO_OPERACAO` ENUM('C', 'V') NULL,
  PRIMARY KEY (`COD_OPERACAO`),
  INDEX `FK_OPERACAO_PESSOA_idx` (`COD_PESSOA` ASC) ,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`USUARIO` (
  ...
  INDEX `FK_USUARIO_PESSOA_idx` (`COD_PESSOA` ASC) ,

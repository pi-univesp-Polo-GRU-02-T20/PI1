...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`CLIENTE` (
  ...
  INDEX `FK_CLIENTE_PESSOA_IDX` (`COD_PESSOA` ASC) ,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`FORNECEDOR` (
  ...
  `COD_PESSOA` INT(11) NOT NULL,
  `NME_RAZAO_SOCIAL` VARCHAR(100) NULL DEFAULT NULL,
  `COD_CNPJ` VARCHAR(100) NULL DEFAULT NULL,
  `COD_CEP` INT(11) NULL DEFAULT NULL,
  `NUM_TELEFONE` VARCHAR(100) NULL DEFAULT NULL,
  `NUM_CELULAR` VARCHAR(100) NULL DEFAULT NULL,
  `DSC_EMAIL` VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`SUBCATEGORIA` (
  ...
  `NME_SUBCATEGORIA` VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`PRODUTO` (
  ...
  `NME_PRODUTO` VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_COMERCIO`.`VENDA` (
  ...
  INDEX `FK_VENDA_TIPO_PAGAMENTO_IDX` (`COD_TIPO_PAGAMENTO` ASC) ,

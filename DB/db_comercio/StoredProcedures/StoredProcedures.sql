...
-- SUBCATEGORIA 
-- CALL SP_CADASTRAR_SUBCATEGORIA('TÊNIS', '10');
DROP PROCEDURE IF EXISTS SP_CADASTRAR_SUBCATEGORIA;	
DELIMITER //
CREATE PROCEDURE SP_CADASTRAR_SUBCATEGORIA (NME_SUBCATEGORIA VARCHAR(100), COD_CATEGORIA INT)
BEGIN
...
-- CALL SP_ALTERAR_SUBCATEGORIA(23, 'TENIS', 10);
DROP PROCEDURE IF EXISTS SP_ALTERAR_SUBCATEGORIA;	
DELIMITER //
CREATE PROCEDURE SP_ALTERAR_SUBCATEGORIA(COD_SUBCATEGORIA INT, NME_SUBCATEGORIA VARCHAR(100), COD_CATEGORIA INT)
BEGIN
	DECLARE ID_CATEGORIA INT;
    SELECT COD_CATEGORIA INTO ID_CATEGORIA 
		FROM CATEGORIA CT 
